...
% Special characters
\def\ellipis{^^^^2026}  % SBL prefers U+2026 over \ldots for ellipes
\def\apos{^^27}         % apostrophe
...
John Calvin observes in his argument introducing the epistle, Hebrews
demonstrates how the figures and shadows of the Law find their fulfilment in
\christ{}, and how the promises given to the fathers are accomplished in Him''.
\footcite[``The Argument,\!'' 15--17]{Calvin1853}
%
Ian Mackervoy similarly observes that the epistle ``argues from the Old
Testament to keep [its readers] trusting in Christ,'' weaving quotations and
exposition into a pastoral appeal for
perseverance. \footcite[Introduction]{MackervoyHebrews}
%
...
In terms of sheer volume, Dana M. Harris collates tallies that range from
thirty-two to thirty-seven explicit quotations of the Old Testament alongside
dozens of allusions, underlining how saturated the sermon is with
Scripture. \footcite[95]{Harris2021} She therefore concludes that ``the
prevalence of the Old
...
a declaration that aligns with God\apos{}s immutability (e.g., Mal 3:6). Ian
Mackervoy therefore stresses that Hebrews opens by proclaiming Jesus\apos{}
divine name and superior status as the foundation for the letter\apos{}s call to
persevering faith. \footcite[on Heb 1:4--9]{MackervoyHebrews}
%
...
consciences where the old covenant failed (Heb 10:1--4, 14). Ian Mackervoy
likewise stresses that Jesus\apos{} once-for-all sacrifice replaces the repeated
offerings of the old arrangement and secures the better agreement promised in
Jeremiah 31. \footcite[on Heb 10:1--18]{MackervoyHebrews}
...
declares the first agreement ``out of date'' and ready to disappear, signalling
the displacement of the Mosaic system in light of \christ{}\apos{}s superior
priesthood and sacrifice. \footcite[on Heb 8:13]{MackervoyHebrews}
%
...
promises embedded in the old covenant, suggesting a deep continuity. Ian
Mackervoy notes that the quotation of Jeremiah 31 in Hebrews 8:8--12 shows God
writing his law on hearts and empowering obedience, so that the new agreement
realises what the first only foreshadowed rather than discarding Israel\apos{}s
story. \footcite[on Heb 8:8--12]{MackervoyHebrews} This motif of fulfilment is
further evident in
...
%
Ian Mackervoy explains that Hebrews invokes Melchizedek to show how Jesus\apos{}
kingly and priestly vocation, undergirded by his own shed blood, secures an
eternal redemption that surpasses the Levitical order. \footcite[on Heb
7:1--10]{MackervoyHebrews}
...
%
Ian Mackervoy observes that Hebrews 11 showcases people who trusted God\apos{}s
promises even when fulfilment lay ahead, modelling the persevering faith the
letter commends. \footcite[on Heb 11:1--7]{MackervoyHebrews}
%
...
%
Ian Mackervoy underscores its urgency, noting that Hebrews 12:14 calls believers
to belong wholly to God because only the holy will see the Lord.
\footcite[on Heb 12:14]{MackervoyHebrews}
%
...
%
Edwards and Mackervoy affirm that holiness and worship, rooted in
\christ{}\apos{}s
...
10:26--31).
%
Ian Mackervoy adds that those who turn back after knowing the truth ``refuse
the one way that God has given,'' and therefore face the fearful judgement that
falls on Christ\apos{}s enemies. \footcite[on Heb 10:26--31]{MackervoyHebrews}
%
...
work.  Ian Mackervoy explains that the promised rest points to a future of
peace and blessing opened by \christ{}, fulfilling what the wilderness
generation only glimpsed. \footcite[on Heb 4:1--11]{MackervoyHebrews}
%
